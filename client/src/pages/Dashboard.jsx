    ...
    <div className='min-h-screen'>
      ...
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
            <img onClick={e => navigate('/')} className='h-9 max-sm:w-32 cursor-pointer' src={assets.logo} alt="" />
            <div className='flex items-center gap-3'>
                <p className='max-sm:hidden'>Welcome, Tanmoy</p>
                <div className='relative group'>
                    <img className='w-8 border border-gray-300/70 rounded-full' src={assets.company_icon} alt="" />
                    <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12 '>
                        <ul className='list-none m-0 p-2 bg-white rounded-md border border-gray-300/70 text-sm'>
      ...
      <div className='flex items-start'>
        ...
        <div className='inline-block min-h-screen border-r-2 border-gray-300/70'>
